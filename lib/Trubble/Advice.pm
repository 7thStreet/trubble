...
my @advice = (
    ...
    "Of course it doesn't work!  That's because you don't know what you are doing!",        "Sure, but you have to have some understanding also.",
...
sub get_advice {
    return $advice[int(rand(scalar(@advice)))];
}
